...
export default function EditBookPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <button
        onClick={() => router.back()}
        className="flex items-center gap-2 mb-2 px-3 py-2 border border-purple-600 text-purple-600 rounded hover:bg-purple-600 hover:text-white transition-colors"
      >
        <svg
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Editar este livro</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              <div className="flex items-center space-x-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    className={`text-3xl transition-colors ${formData.rating && star <= formData.rating
                        ? "text-yellow-400"
                        : "text-gray-300"
