      ...
      >
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-center gap-3 sm:gap-4">
          <button
            onClick={onCancel}
            disabled={isDeleting}
            className="w-full sm:w-auto px-6 py-2.5 border border-purple-600 text-purple-600 rounded hover:bg-purple-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancelar
          </button>
          <button
